...
(cl:defmethod velocity-val ((m <object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader JPDA_UKF_Tracking-msg:velocity-val is deprecated.  Use JPDA_UKF_Tracking-msg:velocity instead.")
  (velocity m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<object>)))
  ...
  "0551e8a26c4794e46875c54cd3aa7a7d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'object)))
  "Returns md5sum for a message object of type 'object"
  "0551e8a26c4794e46875c54cd3aa7a7d")
